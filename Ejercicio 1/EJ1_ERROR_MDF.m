% ------------- EJ1_ERROR_MDF -------------
%
% Programa de análisis del error del Ej. 1
%  con el método de diferencias finitas
%
% -------------- PARÁMETROS ---------------
%
%      Mismos parámetros que EJ1_MDF
%
% -----------------------------------------

function u = EJ1_ERROR_MDF (L_mm = 100, diam_mm = 8, ta = 20, t0 = 50, hp = 200, k = 164, n = 40);
   ...
   u_values = EJ1_MDF(L_mm, diam_mm, ta, t0, hp, k, n)
